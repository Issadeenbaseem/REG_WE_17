            ...
            <div class="card">
             ...
             @endif
                ...
                <form class="forms-sample " method="POST" action="{{ url('upload_doctor') }}" enctype="multipart/form-data">
                    ...
                    <input style="color: black" type="text" class="form-control" name="name" placeholder="Name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Email address</label>
                    <input style="color: black" type="email" class="form-control" name="email" id="exampleInputEmail3" placeholder="Email">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Phone Number</label>
                    <input style="color: black" type="number" class="form-control" name="phone" id="exampleInputEmail3" placeholder="Phone">
                  </div>


                  <div class="form-group">
                    <label for="exampleSelectGender">Doctor Special</label>
                    <select style="color: black" class="form-control" name="special" id="exampleSelectGender">
                  ...
                  <div class="form-group">
                    ...
                    <input style="color: white"  type="text" class="form-control" name="room"  placeholder="Room">
                  </div>
